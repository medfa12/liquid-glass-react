// GENERATED from portable/liquid_glass.glsl + liquid_glass_params.h.
...
/** name -> [floatIndex, componentCount]; offsets are exact (std140). */
export const LAYOUT = {
  halfSize: [0, 2],
  exponent: [2, 1],
  innerRefractAmount: [3, 1],
  innerRefractInvHeight: [4, 1],
  outerRefractAmount: [5, 1],
  outerRefractInvHeight: [6, 1],
  refractOpacity: [7, 1],
  complexRefraction: [8, 1],
  refractThreshold: [10, 2],
  displacementMat: [12, 4],
  refractAngle: [16, 2],
  aberrationAmount: [18, 1],
  aberrationInvHeight: [19, 1],
  aberrationOffset: [20, 1],
  aberrationAngle: [22, 2],
  blurDist: [24, 4],
  blurAlpha: [28, 4],
  blurRadius: [32, 1],
  edgeBleedAmount: [33, 1],
  edgeBleedInvHeight: [34, 1],
  edgeBleedBlurRadius: [35, 1],
  edgeBleedDist: [36, 2],
  edgeBleedOpacity: [38, 1],
  bleedDarken: [40, 2],
  edgeRange: [42, 2],
  edgeOpacity: [44, 2],
  lightDir: [46, 2],
  highlightThreshold: [48, 1],
  highlightHeight: [49, 1],
  highlightSoftness: [50, 1],
  highlightIntensity: [51, 1],
  shadowAmount: [52, 1],
  shadowInvHeight: [53, 1],
  shadowOffset: [54, 2],
  shadowInvRadius: [56, 1],
  shadowOpacity: [57, 1],
  shadowContribution: [58, 1],
  shadowDistOffset: [59, 1],
  faceCM0: [60, 4],
  faceCM1: [64, 4],
  faceCM2: [68, 4],
  bleedCM0: [72, 4],
  ...
  rimGlintGain: [117, 1],
  rimGlintTau: [118, 1],
  ringShadowOffset: [120, 2],
  ringShadowStrokeWidth: [122, 1],
  ringShadowRadius: [123, 1],
  ringShadowOpacity: [124, 1],
  ringShadowMask: [125, 1],
  keyFillDir: [126, 2],
  keyFillHeight: [128, 1],
  keyFillSpread: [129, 1],
  keyFillAmount: [130, 1],
  keyFillEffectOffset: [131, 1],
  keyFillColorBias: [132, 1],
  blurFillBlurRadius: [133, 1],
  blurFillLightenOpacity: [134, 1],
  blurFillDarkenOpacity: [135, 1],
  blurFillNormalOpacity: [136, 1],
};
