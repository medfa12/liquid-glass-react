/** GENERATED from portable/liquid_glass.glsl. Do not edit by hand. */
...
void main() {
  // aPos is a clip-space full-screen triangle strip.
  vUV = aPos * uElementHalfSizePx;      // pixels, origin at element centre
  vBackdropUV = aPos * 0.5 + 0.5;       // normalized backdrop lookup
